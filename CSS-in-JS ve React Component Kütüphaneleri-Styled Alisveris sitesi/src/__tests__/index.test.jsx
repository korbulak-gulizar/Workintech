...
test('Product componentinde styled-components import edilmiş.', () => {
  expect(product.includes('importstyledfrom')).toBe(true);
});

test('Product componentinde styled-component olarak ProductCard oluşturulmuş ve kullanılmış.', () => {
...
test('getClassName fonksiyonu Product componentinden silinmiş', () => {
  expect(product.includes('functiongetClassName()')).not.toBe(true);
});

test("Product.css importu Product componentinden silinmiş", () => {
...
test('Styled componentler Product component fonksiyonun dışında tanımlanmış.', () => {
